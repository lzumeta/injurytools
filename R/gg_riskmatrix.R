...
#' Medicine}, 48(7), 1597–1606. \cr \doi{10.1007/s40279-018-0913-5}
#'
#' @examples
#' \donttest{
...
gg_riskmatrix <- function(injd, by = NULL,
  ...
  p <- ggplot(data = summary_data, aes(x = .data$incidence, y = .data$mean_dayslost, group = !! by)) +
    geom_errorbar(aes(xmin = .data$incidence_lower, xmax = .data$incidence_upper), width = errh_height, orientation = "y") +
