...
#' subject timeline is depicted horizontally where red cross indicates the exact
#' injury date, blue circle the recovery date and bold black line indicates the
...
#'   to drawn. Argument to be passed to
