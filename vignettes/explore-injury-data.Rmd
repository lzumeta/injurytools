...
[^visualize-note-2]: See the *Note* section in `?injprop()` or have a look at this section in [Estimate summary statistics](file:///home/lzumeta/Documents/BCAM_gitlab/injurytools/docs/articles/estimate-epi-measures.html#injprop) vignette, to better understand what the proportions refer to.
