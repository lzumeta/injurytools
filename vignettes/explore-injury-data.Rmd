...
gg_injriskmatrix(injds_perinj, 
  ...
  scale_fill_manual(name = "Type of injury",
                    values = palette[c(5, 1:4)]) +
  theme3
```
</details>


```{r, echo = F, fig.width = 9, fig.height = 5.8}
palette <- c("#000000", "#E69F00", "#56B4E9", "#009E73",
             "#F0E442", "#0072B2", "#D55E00", "#CC79A7")
# source of the palette: http://www.cookbook-r.com/Graphs/Colors_(ggplot2)/
theme3 <- theme(plot.title = element_text(face = "bold", hjust = 0.5, size = 20),
...
```{r, fig.width = 16, fig.height = 3.8}
## Plot just for checking whether cut_injd() worked well
p1 <- gg_injphoto(injd1)
p2 <- gg_injphoto(injd2, fix = TRUE)
...
```{r, echo = F, fig.width = 13, fig.height = 5.8}
palette <- c("#000000", "#E69F00", "#56B4E9", "#009E73",
             "#F0E442", "#0072B2", "#D55E00", "#CC79A7")
# source of the palette: http://www.cookbook-r.com/Graphs/Colors_(ggplot2)/
theme3 <- theme(plot.title = element_text(face = "bold", hjust = 0.5, size = 20),
...
We will plot polar area diagrams[^visualize-note-1].

[^visualize-note-1]: See the *Note* section in `?injprop()` or have a look at this section in [Estimate summary statistics](file:///home/lzumeta/Documents/BCAM_gitlab/injurytools/docs/articles/estimate-epi-measures.html#injprop) vignette, to better understand what the proportions refer to.
