...
[^visualize-note-2]: See the *Note* section in `?injprev()` or have a look at this section in [Estimate summary statistics](file:///home/lzumeta/Documents/BCAM_gitlab/injurytools/docs/articles/estimate-epi-measures.html#injprev) vignette, to better understand what the proportions refer to.
