...
We standardize the key column names such as, player (subject) identifier, dates of injury and recovery (if any), training/match/season date and amount of time of exposure, and set them proper formats by means of `prepare_inj()` and `prepare_exp()`[^prepare-note-2].
